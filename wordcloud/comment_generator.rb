...
class CommentGenerator
  NEW_CLOUD_URL = "https://raw.githubusercontent.com/TheCynicalTeam/TheCynicalTeam/master/previous_clouds/#{CloudTypes::CLOUDLABELS[-2]}_cloud#{CloudTypes::CLOUDLABELS.size - 1}.png"
  ADDWORD = 'add'
